...
export default function ErrorManager({ maxStack=3 }) {
    ...
    const [ errors, setErrors ] = useState([ { title: 'afoiafoafhiofasijpifasfjippafipfaspiafsjpifaspiafsipsjpi  asjpi ajpi afsjpi', description: '123456789afnafoafsafofasfsaobfaspiafspbasipsnipbfspifbasfbpisaajpajpfpijfasjipaspijasfjpaffaijpsjaips' } ])
        ...
        <div className="w-screen h-screen fixed pointer-events-none">
            <button onClick={
                () => setErrors(errors => {
                    ...
                    return [ ...errors, { title: counter + 1, description: 'test' } ]
                })
